...
unsigned char code type1[] = {0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90,0xff,0xbf,0x8e,0xc8,0xc1};
// 数码管位
...
//				Write_24C02_Byte(0x00, num_On_Off);
				f_set_time = 1;  // 时间设置标志
				num1 = set_ds1302_h / 10; num2 = set_ds1302_h % 10; num3 = 11; 
				num4 = set_ds1302_m / 10; num5 = set_ds1302_m % 10; num6 = 11;
				num7 = set_ds1302_s / 10, num8 = set_ds1302_s % 10;
				...
				num1=dis_model;num2=dat[0]%10;num3=11;
				num4=dat[1]/10;num5=dat[1]%10;num6=11;
				num7=dat[2]/10;num8=dat[2]%10;
			}
			// =========================================== 代码结束 ======================================
        }
    }
