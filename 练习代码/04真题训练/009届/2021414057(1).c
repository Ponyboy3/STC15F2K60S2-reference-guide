...
void control()
{
	if(f_2ms == 1)
	{
		...
		if(f_led == 0)//熄灭暂停
		{
			...
			P0 = 0xff;
			P2 &= 0x1f;
			b = ADc_Change();//获取RB2的值对应的亮度值
			if(GN == 1)
			{
				num1=10,num2=10,num3=10,num4=10,num5=10,num6=10,num7=11,num8=a;//a指亮度
				while(Scan_Keys());
